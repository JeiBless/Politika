        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                <li class="nav-item {{ (request()->is('admin/people')) ? 'active' : '' }} ">
                    <a class="nav-link" href="/admin/people">
                ...
                <li class="nav-item {{ (request()->is('admin/political-parties')) ? 'active' : '' }}">
                    <a class="nav-link" href="/admin/political-parties">
                ...
                <li class="nav-item {{ (request()->is('admin/crimes')) ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                ...
                                <form id="form-logout" method="post" action="{{ route('logout') }}">
                                    @csrf
                                    <a class="dropdown-item" onclick="document.getElementById('form-logout').submit();">Cerrar
                                        sesión</a>
                                </form>
                            </div>
                        </li>
